...
class OBBConvFCBBoxHead2(OBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(OBBConvFCBBoxHead2, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(OBBConvFCBBoxHead2, self).init_weights()
...
@HEADS.register_module()
class OBBShared2FCBBoxHead2(OBBConvFCBBoxHead2):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(OBBShared2FCBBoxHead2, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@HEADS.register_module()
class OBBShared4Conv1FCBBoxHead2(OBBConvFCBBoxHead2):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(OBBShared4Conv1FCBBoxHead2, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
