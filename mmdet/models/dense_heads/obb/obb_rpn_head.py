...
class OBBRPNHead(RPNTestMixin, OBBAnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(OBBRPNHead, self).__init__(
    ...
    def _init_layers(self):
        ...
        self.rpn_reg = nn.Conv2d(self.feat_channels, self.num_anchors * self.reg_dim, 1)
    ...
    def loss(self,
        ...
        """
        losses = super(OBBRPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
